...
if(isset($_POST['save'])) {
    try {
        ...
        if($payment_result) {
            ...
            if ($is_ajax) {
                ...
                header("Location: ../models/disbursement.php?success=1");
                exit();
            }
        } else {
        ...
        if ($is_ajax) {
            ...
            echo "<script>window.location='../models/disbursement.php?error=1';</script>";
        }
    }
} else {
    ...
    if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
        ...
        header("Location: ../models/disbursement.php?error=2");
        exit();
    }
}
?>