<?php
// components/business_groups/sidebar.php
?>
...
.sidebar.toggled .business-group-info {
    opacity: 0;
    height: 0;
    padding: 0;
    overflow: hidden;
...
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <div class="back-section">
        <a href="../models/cashier_business_groups.php" class="back-btn">
    ...
    <!-- Business Group Information -->
    <?php if ($groupDetails): ?>
    <div class="business-group-info">
        <h2 class="business-group-name"><?= htmlspecialchars($groupDetails['group_name']) ?></h2>
        <p class="business-group-reference">Business Group</p>
    </div>
    <?php endif; ?>
    ...
    <!-- Group Information -->
    <li class="nav-item">
        <a class="nav-link" href="#" data-section="information">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $(document).on('click', '.nav-link[data-section]', function(e) {
        ...
        setTimeout(function() {
            if (section === 'transactions' && $.fn.DataTable.isDataTable('#transactionsTable')) {
                $('#transactionsTable').DataTable().columns.adjust().responsive.recalc();
            }
        }, 100);
    });
